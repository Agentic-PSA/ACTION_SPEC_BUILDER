...
from src.services.ai_service import analyze_and_save, analyze_and_save_aka
        ...
        for i, (k, v) in enumerate(data.items(), start=1):
            ...
            if potential_new:
                ...
                for category, params in potential_new.items():
                    ...
                    ai_analysis = analyze_and_save_aka(category, all_params[category], params, f'item_{i}', save_to_output_dir)
                    #print(ai_analysis)
                    if ai_analysis:
